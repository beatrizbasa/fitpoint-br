...
<div class="hidden sm:flex sm:items-center sm:ml-6">
    <x-dropdown align="right" width="48">
        <x-slot name="trigger">
            <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-white focus:outline-none focus:text-gray-500 transition duration-150 ease-in-out">
...
@if($adminUser)
    <x-dropdown-link :href="route('admin.edit', ['admin' => $adminUser->id])">
        Edit Admin
    </x-dropdown-link>
@endif
...
@endif
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link href="route('admin.edit', ['admin' => Auth::guard('admin')->user()])">
    {{ __('Profile') }}
                </x-responsive-nav-link>
