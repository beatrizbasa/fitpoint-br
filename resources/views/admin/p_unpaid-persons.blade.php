...
<br><br><br>
    <div class="container mt-3">
        <h1 class="text-danger">Unpaid Persons</h1>
        
        <a href="{{ route('dashboard.index') }}" class="btn btn-outline-dark mt-3 border-2">Back</a>

        <form action="{{ route('payments.unpaid-persons') }}" method="GET" class="col-sm-3 mt-3 float-end ">
        @csrf
        ...
        <div class="table-responsive">
            ...
            <p> Total Paid Person :  <span class="fw-bold text-danger">{{ $unpaidPayments->where('status', 0)->count() }}</span></p>
            </div>
        </div>
    </div>
@endsection
