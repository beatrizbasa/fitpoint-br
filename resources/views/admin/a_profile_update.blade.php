...
<div class="w3-container">
  ...
  <div class="w3-padding-64" style="margin-top: 3rem">
    <div class="row mobile" style="padding: 0rem 15rem 0rem 15rem;">
        ...
        <form action="{{ route('admin.update_profile_changes', Auth::guard('admin')->user()->id) }}" method="POST">
            @csrf
            <div class="col-12">
                <div class="col-4">
                    <label for="inputFname" class="form-label"><b>First name</b></label>
                    <input name="firstname" type="text" class="form-control" id="inputFname" aria-describedby="emailHelp" value="{{ Auth::guard('admin')->user()->firstname }}">
                </div>
                <div class="col-4">
                    <label for="inputFname" class="form-label"><b>Last name</b></label>
                    <input name="lastname" type="text" class="form-control" id="inputFname" aria-describedby="emailHelp" value="{{ Auth::guard('admin')->user()->lastname }}">
                </div>
                <div class="col-4">
                    <label for="inputFname" class="form-label"><b>Address</b></label>
                    <input name="address" type="text" class="form-control" id="inputFname" aria-describedby="emailHelp" value="{{ Auth::guard('admin')->user()->address }} ">
                </div>
                <div class="col-4">
                    <label for="inputFname" class="form-label"><b>Contact no.</b></label>
                    <input name="contact_no" type="text" class="form-control" id="inputFname" aria-describedby="emailHelp" value="{{ Auth::guard('admin')->user()->contact_no }} ">
                </div>
                <div class="col-4">
                    <label for="inputFname" class="form-label"><b>Birthday</b></label>
                    <input name="birthday" type="text" class="form-control" id="inputFname" aria-describedby="emailHelp" value="{{ Auth::guard('admin')->user()->birthday }} ">
                </div>
                <div class="col-4">
