    ...
    <form action="{{ route('clients.update',$client->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <label for="firstname" class="col-md-4 col-form-label text-md-end">{{ __('Firstame') }}</label>
                <input id="firstname" type="text" class="form-control" name="firstname" required autofocus value="{{ $client->firstname }}">
            </div>
         </div>
            ...
            <div class="form-group">
                ...
                <input id="lastname" type="text" class="form-control" name="lastname" required autofocus value="{{ $client->lastname }}">
            </div>
        </div>
            ...
            <div class="input-group">
                <input id="password" type="password" class="form-control" name="password" required value="{{ $client->password }}">
            ...
            <label for="confirm_password" class="col-md-6 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
                <div class="input-group">
                <input id="confirm_password" type="password" class="form-control" name="confirm_password" required value="{{ $client->confirm_password }}">
                <span class="input-group-text">
            ...
            <div class="form-group">
                <label for="contact_no" class="col-md-4 col-form-label text-md-end">{{ __('Contact No') }}</label>
                 <input id="contact_no" type="text" class="form-control" name="contact_no" value="{{ $client->contact_no}}">
        </div></div>
            ...
            <div class="form-group">
                ...
                <input id="birthday" type="date" class="form-control" name="birthday" value="{{ $client->birthday }}">
            </div>
        </div>
