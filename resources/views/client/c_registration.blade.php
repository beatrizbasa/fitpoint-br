        ...
        <div class="row " >
            ...
            <div class="col-6">
                <div class="col-12 adjust-top">
                    <h3 style="font-size: 2.5rem; color: black"><center><b>Register Account</b></center></h3>
                ...
                <div class="col-6 adjust-top">
                    ...
                    <input type="date" class="form-control" id="inputFname" aria-describedby="emailHelp">
                </div>
                <div class="col-6 adjust-top">
                ...
                <div class="col-12">
                <button type="button" class="btn btn-primary" style="padding: .25rem; font-size: 1rem; background-color: black; color: white; border: solid black; float: right; width: 8rem"> Register </button>
                </div>
            </div>
