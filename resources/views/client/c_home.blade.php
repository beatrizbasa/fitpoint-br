...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <!-- <i class="fa-solid fa-dumbbell" style="color: #ff0000;"></i> -->
      <i class="fa-solid fa-dumbbell w3-padding-64 w3-text-red"></i>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <!-- <i class="fa-solid fa-user-group" style="color: #ff0000;"></i> -->
      <i class="fa-solid fa-user-group w3-padding-64 w3-text-red w3-margin-right"></i>
    </div>
